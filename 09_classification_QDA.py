...
### A. Establishes relation between X and y of permafrost data through QDA
...
def outMap(makeTif):
    ...
    if makeTif==1:
        ...
        with rio.Env():
            profile = src.profile
            with rasterio.open("../07_Data/01_Raster/02_Out_Maps/06_QDA.tif", 'w', **profile) as dst:
                dst.write(yPredMap,1)
    print('Map saved at:', os.path.realpath("../07_Data/01_Raster/02_Out_Maps/06_QDA.tif"))
...
def plot1():
    ...
    ax2.set_title('Predicted Map [QDA]', fontsize = 14)
    # ax2.set_yticklabels([])
    # ax2.set_yticks([])
    ...
    # [6.3] save fig
    plt.savefig("../05_Images/03_PredMaps/06_QDA.png", bbox_inches='tight', facecolor='w')
    plt.close()
    print('Plot saved at:', os.path.realpath("../05_Images/03_PredMaps/06_QDA.png"))
plot1()
...
def plot2():
    ...
    # 5 save figure
    plt.savefig("../05_Images/04_Elev_Bands_Pred/06_QDA.png", facecolor='w', bbox_inches='tight')
    plt.close()
    print('Plot saved at:', os.path.realpath("../05_Images/04_Elev_Bands_Pred/06_QDA.png"))
